...
Firmware version in this build: **4.1.1**
...
| File | Purpose |
|------|---------|
| `ACHAS_PREPROD_v4.1.1_merged.bin` | **The one file to flash.** Contains bootloader + partitions + app, already at the right offsets. Flash it to address `0x0`. |
| `ACHAS_PREPROD_v4.1.1_merged.bin.sha256` | Checksum to verify the file above wasn't corrupted. |
...
> Keep future builds under the ~1.9 MB app-slot size. This 4.1.1 build already
